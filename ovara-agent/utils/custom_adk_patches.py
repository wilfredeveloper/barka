...
CUSTOM_STDIO_TIMEOUT_SECONDS = int(os.getenv('MCP_STDIO_TIMEOUT_SECONDS', '100'))  # 100 seconds instead of the default 5 seconds
...
class SessionAwareMCPToolset(MCPToolset):
    ...
    def __init__(
        ...
        """
        Initialize Session-Aware MCPToolset with CustomMcpSessionManager.
